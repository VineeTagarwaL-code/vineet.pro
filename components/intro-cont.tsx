...
export const IntroCont = ({ name, des }: IntroContProps) => {
  ...
  return (
    <div className="">
      <h1 className="text-sky-200/95 text-3xl md:text-8xl font-bold font-grotesk md:before:content-['///'] before:h-[300px] before:text-[175px] before:text-gray-500/50 before:font-[700] before:-z-10  before:select-none before:translate-x-[-100%] before:translate-y-[-20%] webkit_text_stroke before:opacity-[0.25] before:tracking-[-.1em] before:absolute text-[65px] md:text-[96px] text-text_primary relative">
        {name}
      </h1>
      <div className="flex flex-col gap-4 mt-5 md:px-3 ">
        ...
        <h3 className="font-jetbrain text-xl md:text-2xl">
          Converts <span className="text-green-200">prompts</span> into{" "}
      ...
      <div className=" w-full border-solid border-[1px] border-gray-200/20 bg-stone-800/20 max-w-full relative flex items-center justify-start h-[70px] rounded-2xl gap-8 mt-4 md:mx-3">
        ...
        <Clipboard
          className="cursor-pointer text-cyan-300 p-2 w-fit h-fit absolute right-2 md:right-4 rounded-xl border-solid border-[1px]  border-gray-200/20"
          size={20}
          onClick={() => {
            ...
            toast({
              ...
              className:
                "bg-gray-200/90 text-stone-800 border-solid border-[1px] border-gray-200/20 rounded-xl p-4 text-xl",
